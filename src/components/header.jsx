    ...
    <Box sx={{ flexGrow: 20 }}>
      <AppBar position="static" sx={{ bgcolor: "#fff", height: "100px" }}>
        <Toolbar>
          ...
          <svg style={{ width: "30vh", height: "30vh", }} data-v-50d82c62="" width="24" height="24" viewBox="0 0 215 32" fill="none" xmlns="http://www.w3.org/2000/svg" alt="Uzum" class="ui-icon  logo">
          ...
          <Search style={{ background: "#FFFFFF", border: "1px solid #000", width: "30%" }}>
            <SearchIconWrapper>
              <SearchIcon />
            </SearchIconWrapper>
            <StyledInputBase
